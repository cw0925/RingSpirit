...
public class R_Adapter extends BaseAdapter {

    private List<R_SongEntity> mList;
    private LayoutInflater mInflater;

    public R_Adapter(Context context, List<R_SongEntity> list){
        mList = list;
...
//    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        R_SongEntity songEntity = mList.get(position);
